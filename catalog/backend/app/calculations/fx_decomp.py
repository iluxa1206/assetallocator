...
def compute_fx_decomp(
    ...
    """Decompose portfolio return into fund P&L and FX effect for each fund."""
    ...
    for key, w in weights.items():
        ...
        fx0 = fx_rate(native, amount_ccy, row0)
        fxN = fx_rate(native, amount_ccy, rowN)
        ...
        fx_delta_pct = (fxN - fx0) / fx0 if native != amount_ccy else 0.0
